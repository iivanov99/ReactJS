    ...
    checkout: async (req, res, next) => {
      try {
        ...
        await Promise.all([
          ...
          models.MenApparel.updateMany({ name: { $in: insertedOrdersNames } }, { $inc: { ordersCount: 1 } }),
          models.WomenApparel.updateMany({ name: { $in: insertedOrdersNames } }, { $inc: { ordersCount: 1 } }),
          models.Accessory.updateMany({ name: { $in: insertedOrdersNames } }, { $inc: { ordersCount: 1 } }),
        ]);
